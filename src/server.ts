...
export function getOptimalImgFormatByAccept(accept?: string, optimalFormats: ImgFormat[] = OPTIMAL_FORMATS_DEFAULT) {
...
export function getOptimalImgFormatByAgent(agent?: string, optimalFormats: ImgFormat[] = OPTIMAL_FORMATS_DEFAULT) {
  if (!agent) return
